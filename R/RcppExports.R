...
estimate_D <- function(masterZ, E, masterV, map_idxs, n, k, t) {
    .Call(`_DCENt_estimate_D`, masterZ, E, masterV, map_idxs, n, k, t)
}

estimate_E <- function(masterZ, D, masterV, n, k, t) {
    .Call(`_DCENt_estimate_E`, masterZ, D, masterV, n, k, t)
}
